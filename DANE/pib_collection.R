...
page_url <- "https://www.dane.gov.co/index.php/estadisticas-por-tema/cuentas-nacionales/cuentas-nacionales-trimestrales/pib-informacion-tecnica"
...
download_dane_files(
  ...
  file_pattern = "(?i)anex.*\\.xlsx$|gasto.*\\.xlsx$|enfoque.*\\.xlsx$",
  file_prefix = "DANE"
)
...
input_file   <- "DANE_anex_GastoConstantes.xlsx"

#### PIB GASTO AJUSTE ESTACIONAL
process_excel_data(
  ...
  output_file = "1.1 PIB Gasto.xlsx",
  output_sheet = "Gasto_Constante",
  start_cell = c(1, 3), # Seria celda A3 en excel
  start_date = as.Date("2005-03-01"),
  include_dates = T
)

#### PIB GASTO SIN AJUSTE ESTACIONAL
process_excel_data(
  input_folder = input_folder,
  input_file = input_file,
  ...
  output_folder = output_folder,
  output_file = "1.1 PIB Gasto.xlsx",
  output_sheet = "Gasto_Constante_SAE",
  start_cell = c(1, 3), # Seria celda A3 en excel
  start_date = as.Date("2005-03-01"),
  include_dates = T
)

#### PIB GASTO AJUSTE ESTACIONAL: CONSUMO HOGARES
process_excel_data(
  input_folder = input_folder,
  input_file = input_file,
  input_sheet = "Cuadro 4",
  start_col = 3,
  start_row = 15,
  output_folder = output_folder,
  output_file = "1.1 PIB Gasto.xlsx",
  output_sheet = "Consumo_Hogares",
  start_cell = c(1, 3), # Seria celda A3 en excel
  start_date = as.Date("2005-03-01"),
  include_dates = T
)
...
process_excel_data(
  ...
  output_folder = output_folder,
  output_file = "1.1 PIB Gasto.xlsx",
  output_sheet = "Consumo_Hogares_Tipo",
  start_cell = c(1, 3), # Seria celda O3 en excel
  start_date = as.Date("2005-03-01"),
  include_dates = T
)

#### PIB GASTO SIN AJUSTE ESTACIONAL: CONSUMO HOGARES
process_excel_data(
  input_folder = input_folder,
  input_file = input_file,
  ...
  output_folder = output_folder,
  output_file = "1.1 PIB Gasto.xlsx",
  output_sheet = "Consumo_Hogares_SAE",
  start_cell = c(1, 3), # Seria celda A3 en excel
  start_date = as.Date("2005-03-01"),
  include_dates = T
)
...
process_excel_data(
  ...
  output_folder = output_folder,
  output_file = "1.1 PIB Gasto.xlsx",
  output_sheet = "Consumo_Hogares_Tipo_SAE",
  start_cell = c(1, 3), # Seria celda O3 en excel
  start_date = as.Date("2005-03-01"),
  include_dates = T
)

#### PIB GASTO AJUSTE ESTACIONAL: FORMACION BRUTAL DE CAPITAL
process_excel_data(
  input_folder = input_folder,
  input_file = input_file,
  input_sheet = "Cuadro 6",
  start_col = 3,
  start_row = 13,
  output_folder = output_folder,
  output_file = "1.1 PIB Gasto.xlsx",
...
#### PIB GASTO SIN AJUSTE ESTACIONAL: FORMACION BRUTAL DE CAPITAL
process_excel_data(
  input_folder = input_folder,
  input_file = input_file,
  input_sheet = "Cuadro 5",
  start_col = 3,
  start_row = 13,
  output_folder = output_folder,
  output_file = "1.1 PIB Gasto.xlsx",
  output_sheet = "FBKF_SAE",
  start_cell = c(1, 3), # Seria celda A3 en excel
  start_date = as.Date("2005-03-01"),
  include_dates = T
)

#### PIB GASTO AJUSTE ESTACIONAL: COMERCIO EXTERIOR
process_excel_data(
  input_folder = input_folder,
  input_file = input_file,
  input_sheet = "Cuadro 8",
  start_col = 3,
  start_row = 13,
  output_folder = output_folder,
  output_file = "1.1 PIB Gasto.xlsx",
  output_sheet = "Comercio_Exterior",
  start_cell = c(1, 3), # Seria celda A3 en excel
  start_date = as.Date("2005-03-01"),
  include_dates = T
)
...
process_excel_data(
  input_folder = input_folder,
  input_file = input_file,
  input_sheet = "Cuadro 7",
  start_col = 3,
  start_row = 13,
  output_folder = output_folder,
  output_file = "1.1 PIB Gasto.xlsx",
  output_sheet = "Comercio_Exterior_SAE",
  start_cell = c(1, 3), # Seria celda A3 en excel
  start_date = as.Date("2005-03-01"),
  include_dates = T
)
...
##############################################
input_file   <- "DANE_anex_ProduccionConstantes.xlsx"
#### PIB PRODUCCION SIN AJUSTE ESTACIONAL: 12 ACTIVIDADES
process_excel_data(
  input_folder = input_folder,
  input_file = input_file,
  input_sheet = "Cuadro 1",
  ...
  start_row = 15,
  output_folder = output_folder,
  output_file = "1.2 PIB Actividades.xlsx",
  output_sheet = "12_Agrupaciones_SAE",
  start_cell = c(1, 3), # Seria celda A3 en excel
  start_date = as.Date("2005-03-01"),
  include_dates = T
)
...
process_excel_data(
  ...
  output_folder = output_folder,
  output_file = "1.2 PIB Actividades.xlsx",
  output_sheet = "25_Agrupaciones_SAE",
  start_cell = c(1, 3), # Seria celda A3 en excel
  start_date = as.Date("2005-03-01"),
  include_dates = T
)
...
process_excel_data(
  ...
  output_folder = output_folder,
  output_file = "1.2 PIB Actividades.xlsx",
  output_sheet = "61_Agrupaciones_SAE",
  start_cell = c(1, 3), # Seria celda A3 en excel
  start_date = as.Date("2005-03-01"),
  include_dates = T
)

#### PIB PRODUCCION AJUSTE ESTACIONAL: 12 ACTIVIDADES
process_excel_data(
  input_folder = input_folder,
  input_file = input_file,
  input_sheet = "Cuadro 4",
...
libro = "1.1 PIB Gasto.xlsx"
hoja = "Gasto_Constante_SAE"
hoja_1 = "Gasto_Constante"

# PIB con estacionalidad
df <- read.xlsx(paste0(ruta_excel, libro),sheet = hoja, startRow = 2) 
glimpse(df)

# PIB sin estacionalidad
df_1 <- read.xlsx(paste0(ruta_excel, libro),sheet = hoja_1, startRow = 2) 
